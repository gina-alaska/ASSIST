class RenameLookupTables < ActiveRecord::Migration
  def change
    ...
    rename_table :max_depths, :max_depth_lookups
    rename_table :patterns, :pattern_lookups
    rename_table :surface_types, :surface_lookups
    ...
    rename_table :topography_types, :topography_lookups
